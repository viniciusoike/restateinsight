...
Uma solução mais consistente é de usar o pacote `showtext`. [Tenho um post explicando como este pacote funciona](/posts/general-posts/repost-tutorial-showtext/index.qmd). O código abaixo importa a fonte [Montserrat do Google Fonts](https://fonts.google.com/specimen/Montserrat) e aplica no gráfico.
