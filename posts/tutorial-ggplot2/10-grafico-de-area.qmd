...
[^1]: Para uma breve revisão sobre variáveis categóricas ou discretas, consulte o [post](https://restateinsight.com/posts/tutorial-ggplot2/6-scales-labels#variáveis-discretas).
...
O exemplo abaixo mostra como mudar o tipo da linha que fica sobre a área colorida. Para ver os demais tipos de linha consulte o [post inicial sobre gráficos de linha](https://restateinsight.com/posts/tutorial-ggplot2/4-grafico-de-linha#opções-estéticas).
...
p2 <- base_plot +
  geom_area(color = "white", linetype = 1) +
  ggtitle("linetype = 1")
p3 <- base_plot +
  geom_area(color = "white", linetype = 5) +
  ggtitle("linetype = 5")
p4 <- base_plot +
  geom_area(color = "white", linetype = 6) +
  ggtitle("linetype = 6")
...
p2 <- base_plot +
  geom_area(color = "white", linewidth = 1) +
  ggtitle("linewidth = 1")
p3 <- base_plot +
  geom_area(color = "white", linewidth = 2) +
  ggtitle("linewidth = 2")
p4 <- base_plot +
  geom_area(color = "white", linewidth = 5) +
  ggtitle("linewidth = 5")
...
series <- gbcbd_get_series(
  codigos,
  first.date = as.Date("01-03-2011"),
  last.date = as.Date("2022-06-01")
)
...
[^3]: Para uma revisão sobre manipulação de dados consulte o [post da série sobre o asssunto](https://restateinsight.com/posts/tutorial-ggplot2/apendix-manipular-enxergar#manipulando-dados).

```{r, include = FALSE}
wpp <- readr::read_csv(here::here("posts/tutorial-ggplot2/wpp_brazil.csv"))
...
wpp <- read_csv(
  "https://github.com/viniciusoike/restateinsight/raw/main/posts/tutorial-ggplot2/wpp_brazil.csv"
)
...
[^5]: Para mais detalhes sobre como destacar informação com texto consulte o [post da série sobre o assunto](https://restateinsight.com/posts/tutorial-ggplot2/5-grafico-text#usando-texto).
