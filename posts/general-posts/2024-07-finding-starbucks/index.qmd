...
date: "2024-03-23"
categories: ['starbucks', 'web-scrapping', 'data-science', 'brazil', 'tutorial-R', 'finding']
description: "In this post, I show how to find all Starbucks in Brazil using web scraping in R."
execute: 
  message: false
  warning: false
---
