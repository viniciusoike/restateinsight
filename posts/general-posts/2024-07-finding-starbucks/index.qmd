...
description: "In this post, I show how to find all Starbucks in Brazil using web scraping in R. I also show how to use the Google Places API to add ratings information for all Starbucks units."
execute: 
  message: false
  warning: false
---
