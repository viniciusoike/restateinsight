...
execute:
  ...
  message: false
  fig-align: center
image: "/static/images/posts/2023-10-wz-metro-sp/metro-sp-linhas.png"
image-alt: "/static/images/posts/2023-10-wz-metro-sp/metro-sp-linhas.png"
---
...
Station-level data reveals significant variation in recovery trajectories. Oscar Freire is the only station to exceed pre-pandemic levels, reaching 105% of its 2019 ridership by mid-2023. Most other stations remain well below baseline, with Luz at 89%, Fradique Coutinho at 80%, and Pinheiros at 78%. Surprisingly, Paulista—despite being located in São Paulo's premier commercial district—shows one of the weakest recoveries at only 70% of 2019 levels, comparable to República (68%) and Butantã (66%). São Paulo-Morumbi has recovered the least, at just 50%. This heterogeneity suggests that recovery depends on complex factors beyond simple residential versus commercial distinctions, possibly including specific employment patterns, alternative transportation options, and localized changes in urban activity.
