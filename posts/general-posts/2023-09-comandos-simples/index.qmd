...
Outro ponto, um pouco óbvio, é que há nomes que devemos evitar na hora de nomear nossas colunas como: `FALSE`, `if`, `TRUE`, `for`, `Inf`, etc[^4].

[^4]: Estas palavras são "nomes reservados" dentro do `R` e jamais devem ser utilizados na hora de definir um objeto ou o nome de uma coluna. Para consultar a lista de nomes reservados, veja `help("Reserved")`.
