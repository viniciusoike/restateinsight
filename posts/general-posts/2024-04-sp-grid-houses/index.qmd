...
execute:
  ...
  message: false
  echo: false
image: "/static/images/posts/2024-04-sp-grid-houses/mapa-spo-densidade-dom.png"
image-alt: "/static/images/posts/2024-04-sp-grid-houses/mapa-spo-densidade-dom.png"
---
...
sp_border <- geobr::read_municipality(
  3550308,
  year = 2010,
  showProgress = FALSE
)
...
censo22 <- data.table::fread(
  "/Volumes/T7 Touch/github/tidyibge/data-raw/35.csv"
)
...
map_sp <- ggplot() +
  geom_sf(data = sp_border, lwd = 0.05, fill = NA, color = "gray10") +
  geom_sf(
  ...
  ggthemes::theme_map(base_family = "Helvetica Neue") +
  theme(
    legend.position = "top",
...
if (interactive()) {
  output_dir <- here::here("static/images/posts/2024-04-sp-grid-houses")
  dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

  ggsave(
    here::here(output_dir, "map.svg"),
    map_sp,
    width = 9,
    height = 12,
    device = "svg"
