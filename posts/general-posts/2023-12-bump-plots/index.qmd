...
execute: 
  warning: false
  message: false
image-alt: "/static/images/ggplot2_tutorial/replication_economist_bump_plot.jpeg"
image: "/static/images/ggplot2_tutorial/replication_economist_bump_plot.jpeg"
---
...
Podemos analisar as cidades com maior número de vendas ao longo dos anos usando a já conhecida `txhousing`. Quem [acompanha meus tutoriais de ggplot2](https://restateinsight.com/posts/tutorial-ggplot2/) já deve estar cansado de ver esta base sendo utilizada.
