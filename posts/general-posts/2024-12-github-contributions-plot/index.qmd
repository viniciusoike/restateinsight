...
execute: 
  warning: false
image: "/static/images/posts/2024-12-github-contributions-plot/github_contributions.png"
image-alt: "/static/images/posts/2024-12-github-contributions-plot/github_contributions.png"
---

In this post I'll show how to replicate the infamous GitHub contributions graphic. This visualization shows all the days of the year and highlights the most "productive" days in darker colors. It's similar to a heat map and also known as a cluster map. You can check other examples of this plot in my [tutorial post](https://restateinsight.com/posts/tutorial-ggplot2/11-grafico-calor#gráfico-de-calor) (in Portuguese). In a way, it's also fairly similar to a "punchcard" plot.

![](/static/images/posts/2024-12-github-contributions-plot/github_contributions.png){fig-align="center"}
