...
A nuance that is not captured by the graphic is the frequency of currency changes during this era[^3]. With almost all of the new plans, came a new currency, so the valleys in plot during the 1980s and early 1990s coincide with price freezes and currency swaps.
