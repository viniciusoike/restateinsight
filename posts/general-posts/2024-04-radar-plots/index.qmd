...
execute: 
  ...
  warning: false
  eval: true
image: "/static/images/posts/2024-04-radar-plots/radar-plots-1.png"
image-alt: "/static/images/posts/2024-04-radar-plots/radar-plots-1.png"
---
...
Lollipop charts are good at showing the temporal change between the same group of variables. I featured this chart in my [ggplot2 tutorials (in Portuguese)](https://restateinsight.com/posts/tutorial-ggplot2/8-lollipop#expectativa-de-vida). The code below shows how to make a simple lollipop chart using this data.
