...
execute:
  message: false
  warning: false
image: "/static/images/posts/2023-11-replicating-plots/plot_ft.png"
image-alt: "/static/images/posts/2023-11-replicating-plots/plot_ft.png"
---
...
import::from(sysfonts, font_add, font_add_google)
```
...
# [1] patchwork_1.3.1 tidyr_1.3.2     dplyr_1.2.1     forcats_1.0.1
# [5] stringr_1.6.0   ggplot2_4.0.2
```
...
![](/static/images/posts/2023-11-replicating-plots/plot_folha_sp.png){fig-align="center"}
...
![](/static/images/posts/2023-11-replicating-plots/plot_ft.png){width="80%" fig-align="center"}
...
![](/static/images/posts/repost-crescimento-pib-mundo/grafico_nexo_crescimento.png){fig-align="center"}
...
![](/static/images/ggplot2_tutorial/economist_bump_plot.jpeg){fig-align="center" width="400"}
...
dat <- readr::read_csv(
  here::here(
    "static/data/gdp_over_hours_worked_with_estimated_hours_worked.csv"
  )
)
...
![](/static/images/posts/2023-09-happiness/owid_happiness.png)
...
#| echo: false
owid <- readr::read_csv(
  here::here("static/data/gdp-vs-happiness.csv")
)
