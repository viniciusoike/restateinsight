...
description: "Neste post ensino abordagens diferentes para agregar dados de maneira eficiente. Apresento também as novidades que o `dplyr` trouxe nos últimos anos como as funções tidyselectors, que ajudam a selecionar colunas com base em padrões lógicos."
