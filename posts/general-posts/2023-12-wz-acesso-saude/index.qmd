...
execute:
  warning: false
  message: false
image: "/static/images/posts/2023-12-wz-acesso-saude/mapa-spo-acesso-saude.png"
image-alt: "/static/images/posts/2023-12-wz-acesso-saude/mapa-spo-acesso-saude.png"
---
...
```{r import-data}
#| include: false
cnes = data.table::fread(
  here::here("static/data", "cnes_estabelecimentos.csv")
)
leitos = data.table::fread(
  here::here("static/data", "Leitos_2024.csv"),
  encoding = "Latin-1"
)
```
...
geo_locations <- qs::qread(here::here(
  "static/data/isocronas_geo_locations_sp.qs"
))
```
