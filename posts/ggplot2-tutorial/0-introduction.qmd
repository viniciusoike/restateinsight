...
Nesta série, exploraremos uma das ferramentas mais poderosas e versáteis para visualização de dados - o pacote ggplot2 em R.
...
Se você está animado para começar, vá para [aqui](./ggplot2-tutorial/01-introduction.html) para acessar o primeiro tutorial da série.
