...
Vou discutir majoritariamente sobre objetos espaciais no formato de vetores (*vector shape file*) já que eles são mais prevalentes nas ciências socias em geral. Vou mostrar apenas um exemplo usando dados em formato *raster*.
