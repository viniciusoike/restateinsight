...
<div class="app-grid">
  ...
  <div class="app-card" data-cat="urban stable" data-href="https://restateinsight.com/posts/shiny-apps/ifdm">
    ...
    <div class="app-body">
      ...
      <p class="app-desc">Dashboard for exploring the Firjan Municipal Development Index (IFDM) across Brazilian municipalities (2013–2023). Search any city, benchmark it against state/regional/national averages, track Education, Health, and Employment & Income over time, and export the underlying data.</p>
      <div class="app-footer">
        <div class="app-badges">
        ...
        <div class="app-links">
          <a class="app-link-primary" href="https://viniciusoike-shiny-firjan-ifdm.share.connect.posit.cloud" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            Open app
          </a>
  ...
  <div class="app-card" data-cat="realestate dev">
    <div class="app-thumb">
      <img
        src="static/images/apps/cover_shiny_painel.png"
        alt="Painel do Mercado Imobiliário app screenshot">
    </div>
    <div class="app-body">
      <p class="app-name">Painel do Mercado Imobiliário</p>
      <p class="app-desc">Dashboard for monitoring the Brazilian real estate market. Tracks price indices (FipeZap, RPPI), interest rates (Selic, IPCA), credit flows (SBPE), and regional indicators for São Paulo, built on top of the <code>realestatebr</code> package.</p>
      <div class="app-footer">
        <div class="app-badges">
        ...
        <div class="app-links">
          <a class="app-link-primary" href="https://viniciusoike-shiny-painel-mercado.share.connect.posit.cloud" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            Open app
          </a>
  ...
  <!-- Metrô SP -->
  <div class="app-card" data-cat="mobility stable" data-href="https://restateinsight.com/posts/shiny-apps/metrosp-explorer">
    <div class="app-thumb">
      <img
        src="static/images/apps/cover_shiny_metrosp.png"
        alt="Metrô SP app screenshot">
    </div>
    <div class="app-body">
      <p class="app-name">Metrô SP</p>
      <p class="app-desc">Dashboard for São Paulo Metro ridership. Explore demand by line and by station, an animated map of yearly boardings across the network, year-over-year and 2019-recovery comparisons, built on top of the <code>metrosp</code> package.</p>
      <div class="app-footer">
        <div class="app-badges">
        ...
        <div class="app-links">
          <a class="app-link-primary" href="https://viniciusoike-metrosp-explorer.share.connect.posit.cloud" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            Open app
          </a>
          <a class="app-link" href="https://github.com/viniciusoike/metrosp-explorer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .3a12 12 0 0 0-3.8 23.4c.6.1.8-.3.8-.6v-2c-3.3.7-4-1.6-4-1.6-.6-1.4-1.4-1.8-1.4-1.8-1-.7.1-.7.1-.7 1.2.1 1.8 1.2 1.8 1.2 1 1.8 2.8 1.3 3.5 1 .1-.8.4-1.3.7-1.6-2.7-.3-5.5-1.3-5.5-5.9 0-1.3.5-2.4 1.2-3.2 0-.4-.5-1.6.2-3.2 0 0 1-.3 3.3 1.2a11.5 11.5 0 0 1 6 0c2.3-1.5 3.3-1.2 3.3-1.2.7 1.6.2 2.8.1 3.2.8.8 1.2 1.9 1.2 3.2 0 4.6-2.8 5.6-5.5 5.9.4.4.8 1.1.8 2.2v3.3c0 .3.2.7.8.6A12 12 0 0 0 12 .3"/></svg>
            GitHub
          </a>
        </div>
